...
// import { JobInfoList, DegreeInfo } from '../../app/types';
// import { FaFilePdf } from 'react-icons/fa';
// import Link from 'next/link';
// import Image from 'next/image';
// import WorkExperience from '../../app/components/work-experience-section';
// import Contacts from '../../app/components/contacts';
// import AsideBlock from '../../app/components/utils/aside-block';
...
//       <aside
//         id="about-me"
//         className={`flex flex-col md:sticky md:max-w-max md:w-1/3 md:h-screen max-sm:w-full max-sm:gap-2 top-0 px-1 ${styles.aside}`}
//       >
...
//               Dmitry <span className="font-semibold">Metelev</span>
//             </h1>
//           </div>
...
//             <FaFilePdf />
//             <Link href="/Metelev_CV.pdf">Download CV</Link>
//           </div>
...
//           <li>
//             Six years of experience specializing in{' '}
//             <b>frontend and fullstack development</b>.
//           </li>
//           <li>
//             Skilled in <b>team leadership</b> and working across diverse
//             industries including B2B, B2C, and Web3.
//           </li>
//           <li>
//             Able to work <b>both as a team-player and solo</b>
//           </li>
//           <li>
//             Vast <b>international communication</b> experience
//           </li>
//         </ul>
//         <h1 id="work-experience" className="text-3xl font-semibold text-left">
//           Work experience
//         </h1>
//         <Divider className="max-sm:hidden" />
